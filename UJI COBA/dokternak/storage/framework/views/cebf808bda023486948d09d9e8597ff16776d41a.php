...
<html lang="en-US">
  <head>
    ...
    <link href="<?php echo e(asset('Petugas/css/aos.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('Petugas/css/bootstrap.min.cs')); ?>s" rel="stylesheet">
    <link href="<?php echo e(asset('Petugas/styles/main.css')); ?>" rel="stylesheet">

    <!-- CSS here -->
   <link rel="stylesheet" href="<?php echo e(asset('Petugas/assets/css/bootstrap.min.css')); ?>">
            <link rel="stylesheet" href="<?php echo e(asset('Petugas/assets/css/owl.carousel.min.css')); ?>">
            <link rel="stylesheet" href="<?php echo e(asset('Petugas/assets/css/flaticon.css')); ?>">
            <link rel="stylesheet" href="<?php echo e(asset('Petugas/assets/css/price_rangs.css')); ?>">
            <link rel="stylesheet" href="<?php echo e(asset('Petugas/assets/css/slicknav.css')); ?>">
            <link rel="stylesheet" href="<?php echo e(asset('Petugas/assets/css/animate.min.css')); ?>">
            <link rel="stylesheet" href="<?php echo e(asset('Petugas/assets/css/magnific-popup.css')); ?>">
            <link rel="stylesheet" href="<?php echo e(asset('Petugas/assets/css/fontawesome-all.min.css')); ?>">
            <link rel="stylesheet" href="<?php echo e(asset('Petugas/assets/css/themify-icons.css')); ?>">
            <link rel="stylesheet" href="<?php echo e(asset('Petugas/assets/css/slick.css')); ?>">
            <link rel="stylesheet" href="<?php echo e(asset('Petugas/assets/css/nice-select.css')); ?>">
            <link rel="stylesheet" href="<?php echo e(asset('Petugas/assets/css/style.css')); ?>">
 ...
 <?php echo $__env->make('frontend/layouts.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
  ...
  <div class="page-content">
    ...
    <div class="profile-page">
      <div class="wrapper">
        <div class="page-header page-header-small" filter-color="green">
          <div class="page-header-image" data-parallax="true" style="background-image: <?php echo e(asset('Frontend/assets/img/gallery/s2.jpg')); ?>"></div>
          <div class="container">
            <div class="content-center">
              <div class="cc-profile-image"><a href="#"><img src="/data/data_puskeswan/<?php echo e($puskeswan->gambar); ?>" alt="Image"/></a></div>
              <div class="h2 title"><?php echo e($puskeswan->nama_puskeswan); ?></div>
              <p class="capt"><?php echo e($puskeswan->alamat); ?></p>
              <a class="genric-btn primary" href="<?php echo e($puskeswan->maps); ?>" terget="_blank">Cek Lokasi</a>
            </div>
          </div>
          <div class="section">
          ...
          <div class="row">
            <div class="col-lg-6 col-md-12">
              <div class="card-body">
                ...
                <p><?php echo e($puskeswan->jam_kerja); ?></p>
              </div>
            </div>
            <div class="col-lg-6 col-md-12">
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8"><?php echo e($puskeswan->alamat); ?></div>
                </div>
            </div>
          </div>
        </div>
    ...
    <!-- Java Script -->
    <script src="<?php echo e(asset('Petugas/js/core/jquery.3.2.1.min.js')); ?>"></script>
    <script src="<?php echo e(asset('Petugas/js/core/popper.min.js')); ?>"></script>
    <script src="<?php echo e(asset('Petugas/js/core/bootstrap.min.js')); ?>"></script>
    <script src="<?php echo e(asset('Petugas/js/now-ui-kit.js?v=1.1.0')); ?>"></script>
    <script src="<?php echo e(asset('Petugas/js/aos.js')); ?>"></script>
    <script src="<?php echo e(asset('Petugas/scripts/main.js')); ?>"></script>
...
</html><?php /**PATH C:\xampp\htdocs\Kel_4_Gol_F_BWS\UJI COBA\dokternak\resources\views/frontend/detailpuskeswan.blade.php ENDPATH**/ ?>