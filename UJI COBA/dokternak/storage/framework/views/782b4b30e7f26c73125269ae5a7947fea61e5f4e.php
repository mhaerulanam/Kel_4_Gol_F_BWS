                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="right-caption">
                            ...
                            <div class="section-tittle section-tittle2">
                                <span>TUTORIAL</span>
                                <h2><?php echo e($tutorial->judul_tutorial); ?></h2>
                            </div>
                            <div class="support-caption">
                                ...
                                <p><?php echo e($tutorial->isi); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                        <div class="support-location-img">
                            <img class="card-img rounded-0" src="/data/data_tutorial/<?php echo e($tutorial->icon); ?>">
                        </div>
                    </div>
                </div> 
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\Kel_4_Gol_F_BWS\UJI COBA\dokternak\resources\views/frontend/detailtutorial.blade.php ENDPATH**/ ?>