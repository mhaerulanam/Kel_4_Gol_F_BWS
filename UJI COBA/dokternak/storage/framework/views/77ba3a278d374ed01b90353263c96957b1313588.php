            ...
            <div class="card shadow">
              <div class="card-body">
                <div class="row align-items-center mb-2">
                  ...
                  <div class="col-auto">
                    <div class="form">
                      <a href="<?php echo e(route('peternak.create')); ?>"><button class="btn btn-primary"
...
<?php echo $__env->make('backend/layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Kel_4_Gol_F_BWS\UJI COBA\dokternak\resources\views/backend/peternak/index.blade.php ENDPATH**/ ?>