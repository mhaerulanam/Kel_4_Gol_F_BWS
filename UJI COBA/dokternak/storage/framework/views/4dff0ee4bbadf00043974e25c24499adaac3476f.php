            ...
            <div class="card shadow">
              <div class="card-body">
                <div class="row align-items-center mb-2">
                  ...
                  <div class="col-auto">
                    <div class="form">
                      <a href="<?php echo e(route('data_puskeswan.create')); ?>"><button class="btn btn-primary"
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                        <div class="btn-group">
                            <a href="<?php echo e(route('data_puskeswan.edit',$item->id_puskeswan)); ?>" class="btn btn-warning">Edit<i class="fa fa-edit"></i></a>
                            <form action="<?php echo e(route('data_puskeswan.destroy',$item->id_puskeswan)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend/layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Kel_4_Gol_F_BWS\UJI COBA\dokternak\resources\views/backend/data_puskeswan/index.blade.php ENDPATH**/ ?>