      ...
      <div class="row justify-content-center">
        <div class="col-12">
          <header class="panel-heading">
            <?php echo e(isset($admin_lecturer) ? 'Mengubah' : 'Menambahkan'); ?> Admin
        </header>
          <?php if($errors->any()): ?>
              ...
              <div class="card shadow">
                ...
                <div class="card-body">
                  <form class="needs-validation" id="admin_form" method="POST"
                            action="<?php echo e(isset($admin) ? route('admin.update',$admin->id) : 
                            route('admin.store')); ?>">
                                <?php echo csrf_field(); ?>
                      ...
                      <div class="col-md-6 mb-3">
                        ...
                        value="<?php echo e(isset($admin) ? $admin->name : ''); ?>"  
                            required>
                    ...
                    <div class="col-md-4 mb-3">
                      ...
                      <div class="input-group">
                        ...
                        value="<?php echo e(isset($admin) ? $admin->password : ''); ?>"  
                        required>
                    ...
                    <a href="<?php echo e(route('admin.index')); ?>"><button class="btn btn-default"
...
<?php echo $__env->make('backend/layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Kel_4_Gol_F_BWS\UJI COBA\dokternak\resources\views/backend/admin/create.blade.php ENDPATH**/ ?>