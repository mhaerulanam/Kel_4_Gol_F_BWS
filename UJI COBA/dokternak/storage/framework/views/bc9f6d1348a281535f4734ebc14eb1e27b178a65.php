...
Sistem Informasi Dokter Hewan yang merupakan sistem informasi berbasis website untuk mempermudah para peternak dalam mencari dokter hewan terdekat serta para peternak dapat berkonsultasi melalui website dengan dokter hewan yang sesuai tentang permasalahan yang dihadapi oleh para peternak seperti penyakit pada ternak. Di dalam website ini juga terdapat tips dan trik dalam berternak yang baik dan benar, sehingga para peternak dapat lebih mudah mengetahui atau menambah ilmu wawasan tentang peternakan. Para peternak juga dapat menulis sebuah catatan pengalaman untuk dibagikan ke website, agar para peternak lain mengetahui tentang pengalaman penulis.
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="support-location-img">
                    <img src="<?php echo e(asset('Frontend/assets/img/gallery/kami.jpg')); ?>" alt="">
...
<div class="apply-process-area apply-bg pt-150 pb-150" data-background="<?php echo e(asset('Frontend/assets/img/gallery/s2.jpg')); ?>">
    <div class="container">
        <!-- Section Tittle -->
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="h1-testimonial-active dot-style">
                    ...
                    <div class="single-testimonial text-center">
                        ...
                        <div class="testimonial-caption ">
                            ...
                            <div class="testimonial-founder  ">
                                ...
                                <img src="<?php echo e(asset('Frontend/assets/img/gallery/anam.jpg')); ?>" class="radiuz" alt="">
                    ...
                    <div class="single-testimonial text-center">
                        ...
                        <div class="testimonial-caption ">
                            ...
                            <div class="testimonial-founder  ">
                                <div class="founder-img mb-30">
                                    <img src="<?php echo e(asset('Frontend/assets/img/gallery/ardan.jpg')); ?>" class="radiuz" alt="">
                    ...
                    <div class="single-testimonial text-center">
                        ...
                        <div class="testimonial-caption ">
                            ...
                            <div class="testimonial-founder  ">
                                <div class="founder-img mb-30">
                                <img src="<?php echo e(asset('Frontend/assets/img/gallery/defi.jpg')); ?>" class="radiuz" alt="">
                    ...
                    <div class="single-testimonial text-center">
                        ...
                        <div class="testimonial-caption ">
                            ...
                            <div class="testimonial-founder  ">
                                <div class="founder-img mb-30">
                                    <img src="<?php echo e(asset('Frontend/assets/img/gallery/wike.jpg')); ?>" class="radiuz" alt="">
                    ...
                    <div class="single-testimonial text-center">
                        ...
                        <div class="testimonial-caption ">
                            ...
                            <div class="testimonial-founder  ">
                                <div class="founder-img mb-30">
                                    <img src="<?php echo e(asset('Frontend/assets/img/gallery/widya.jpg')); ?>" class="radiuz" alt="">
...
<section>
        <?php echo $__env->make('frontend/kritikdansaran', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
</section>
</main>
<!-- Testimonial End -->
<section>
...
</html><?php /**PATH C:\xampp\htdocs\Kel_4_Gol_F_BWS\UJI COBA\dokternak\resources\views/frontend/tentangkami.blade.php ENDPATH**/ ?>