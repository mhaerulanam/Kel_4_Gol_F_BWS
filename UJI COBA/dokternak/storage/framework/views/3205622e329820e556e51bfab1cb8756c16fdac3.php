          ...
          <div class="row">
            <div class="col-lg-6 col-md-12">
              <div class="card-body">
                ...
                <p><?php echo e($dokter->jadwal_kerja); ?></p>
                <div class="h4 mt-0 title">Wilayah Kerja</div>
                <p><?php echo e($dokter->tempat); ?></p>
              </div>
            </div>
            <div class="col-lg-6 col-md-12">
              <div class="card-body">
                ...
                <div class="row mt-3">
                  ...
                  <div class="col-sm-8"><?php echo e($dokter->jenis_kelamin); ?></div>
                </div>
                <div class="row mt-3">
                ...
                <div class="row mt-3">
                  ...
                  <div class="col-sm-8"><?php echo e($dokter->alamat); ?></div>
                </div>
                <div class="row mt-3">
                  <div class="col-sm-4"><strong class="text-uppercase">Email</strong></div>
                  <div class="col-sm-8"><?php echo e($dokter->email); ?></div>
                </div>
              </div>
            </div>
          </div>
...
</html><?php /**PATH C:\xampp\htdocs\Kel_4_Gol_F_BWS\UJI COBA\dokternak\resources\views/frontend/detaildokter.blade.php ENDPATH**/ ?>