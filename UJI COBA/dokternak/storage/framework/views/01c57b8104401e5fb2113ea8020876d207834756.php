                                ...
                                <div class="single-job-items mb-30">
                                    <div class="job-items">
                                        <div class="company-img">
                                            <a><img class="center" src="/data/data_dokter/<?php echo e($data_dokter->foto); ?>" alt="" width="100" height="100"></a>
                                        </div>
                                        <div class="job-tittle">
                                            <a href="/dokter/<?php echo e($data_dokter->id_dokter); ?>/detail/"><h4><?php echo e($data_dokter->nama_dokter); ?></h4></a>
                                            <ul>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                        <div class="single-services text-center mb-30">
                            ...
                            <div class="services-cap">
                               ...
                               <div class="items-link f-right">
                                <a href="/home/tutorial/<?php echo e($data_tutorial->id_tutorial); ?>/detail/">Detail</a>
                               </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Kel_4_Gol_F_BWS\UJI COBA\dokternak\resources\views/frontend/home.blade.php ENDPATH**/ ?>