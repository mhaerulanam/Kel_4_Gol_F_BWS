...
<head>
   ...
   <!-- CSS here -->
      ...
      <link rel="stylesheet" href="<?php echo e(asset('Frontend/assets/css/style3.css')); ?>">
<style>
.tabs {
  position: relative;
  margin: 3rem 0;
    ...
    <div class="pagination-area pb-200 text-center">
                ...
                <table>
                    <tbody>
                          ...
                          <?php $__currentLoopData = $dokter; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data_dokter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                          <article class="blog_item">
                                            <div class="col-md-10">
                                                <div class="our-team">
                                                <div class="pic">
                                                    <img class="card-img rounded-0" src="data:image/png;base64,<?php echo e(chunk_split(base64_encode($data_dokter->foto))); ?>" alt="gambar dokter" width="300px">
                                                </div>
                                                <div class="blog_details">
                                                    
                                                    <div class="team-content">
                                                        <h4 class="title"><?php echo e($data_dokter->nama_dokter); ?></h4>
                                                        <span class="post"><?php echo e($data_dokter->id_jabatan); ?> </span>
                                                        <span class="post"><?php echo e($data_dokter->tempat); ?></span>
                                                        <p><span class="post"><?php echo e($data_dokter->telpon); ?></span></p><br>
...
</html><?php /**PATH C:\xampp\htdocs\Kel_4_Gol_F_BWS\UJI COBA\dokternak\resources\views/frontend/dokter.blade.php ENDPATH**/ ?>