                ...
                <div class="row">
                    <table>
                        <tbody>
                            ...
                            <?php $__currentLoopData = $puskeswan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data_puskeswan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                    ...
                                    <div class="col-lg-4 col-md-4">
                                        ...
                                        <div class="item-box-blog-body">
                                            ...
                                            <a href="#" tabindex="0">
                                            <h4><b><?php echo e($data_puskeswan->nama_puskeswan); ?></b></h4>
                                                <!-- <h4><b><?php echo e($data_puskeswan->nama_puskeswan); ?>;</b></h4> -->
                                            </a>
                                            </div>
                                    <!--Text-->
                                    <div class="item-box-blog-text">
                                    <p><?php echo e($data_puskeswan->alamat); ?></p>
                                    </div>
                                    <div class="services-cap">
                                        <a href="/puskeswan/<?php echo e($data_puskeswan->id_puskeswan); ?>/detail/" class="genric-btn primary radius">Detail</a>
                                        </div>
                                        </div>
                                </div>
                            </div> 
...
</html><?php /**PATH C:\xampp\htdocs\Kel_4_Gol_F_BWS\UJI COBA\dokternak\resources\views/frontend/puskeswan.blade.php ENDPATH**/ ?>