                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                        <div class="btn-group">
                            <a href="{{ route('data_banner.edit',$item->id_banner)}}" class="btn btn-warning">Edit<i class="fa fa-edit"></i></a>
                            <form action="{{ route('data_banner.destroy',$item->id_banner)}}" method="POST">
                            @csrf
                                @method('DELETE')
