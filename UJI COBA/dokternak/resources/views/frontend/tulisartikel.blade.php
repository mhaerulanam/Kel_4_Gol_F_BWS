    ...
    <div class="slider-active">
        <div class="section-top-border">
            <div class="kotak">
                <div class="row">
	                <div class="col-lg-12 ">
                    <form method="POST" action="tulisartikel.store" enctype="multipart/form-data">
                        <!-- <div class="mt-30"> -->
                        ...
                        <h5 class="mb-15">Kategori</h5>
                            <input list="id_ktg" class="form-control" placeholder='Masukkan Jenis Hewan' value="" name="id_ktg">
